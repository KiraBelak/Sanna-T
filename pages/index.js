        ...
        <MainLayout>
          ...
          {session ? (
            <Transition
              ...
              leaveTo="opacity-0"
              className="flex flex-col items-center box-border h-full min-h-screen bg-gradient-to-br from-gen-rosita via-gen-menta to-gen-rosaPastel"
            >
              {/* {// Landing page} */}
              ...
              <div className="flex flex-col items-center justify-center mt-2">
                <h1
                  className="text-2xl font-extrabold justify-center text-center text-black mb-2"
                  style={{ fontFamily: "Roboto" }}
                >
                ...
                <div className="flex flex-row items-center flex-wrap justify-center">
                  <Link href="/menu/actividads">
                    <a className="hover:bg-gen-azul bg-gen-rosaPastel text-white font-bold mx-2 mb-2 py-2 px-4 rounded shadow-lg shadow-slate-600">
                      Actividades{" "}
                    </a>
                  </Link>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p
                  ...
                  style={{ fontFamily: "Roboto" }}
                >
                  Sanna-T es una plataforma que te permite encontrar
                  profesionales de la salud mental y bienestar, para que puedas
                  encontrar el profesional que mejor se adapte a tus
